...
(function (root) {
  ...
  var CALIBRATION =
  {
    "provenance": "data_all/time_entries.csv (2,360 entries, 2123.5h, 2024-08-19..2026-06-12, ODL staff time) | 25 full-coverage course-dev projects >=10h (derived/ground_truth.csv); production rates from the 21 of them with >=10h non-PM logging",
    ...
    "coursePhaseMixPct": {
      "Production": 31.4,
      "Post-Production": 24.8,
      "Development/Build": 17.1,
      "Pre-Production": 16.9,
      "Design": 8.3,
      "Other / unsorted": 1.0,
      "Discovery": 0.4
    },
    "coursePhaseMixBasis": "pooled non-PM hours of 14 full-coverage full_course projects (908.3h)",
    "calendarWeeks": {
      "consult_or_studio": {
        "n": 1,
        "values": [
    ...
    "impactTracker": {
      ...
      "basis": "data_all/projects.csv Asana project custom field across 129 pulled projects",
      "total_projects": 129,
      "tracked_projects": 31,
      "blank_projects": 98,
      "coverage_pct": 24.0,
      ...
      "hours_crosscheck": {
        ...
        "rows": [
          ...
          },
          {
            ...
            "asana_logged_hours": 86.8,
            "ratio_logged_over_reported": 0.72
          }
        ],
