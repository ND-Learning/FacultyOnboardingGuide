...
(function (root) {
  ...
  var CALIBRATION =
  {
    "provenance": "data_all/time_entries.csv (3,358 entries, 2927.8h, 2024-07-10..2026-09-11, ODL staff time) | 23 full-coverage course-dev projects >=10h (derived/ground_truth.csv); production rates from the 19 of them with >=10h non-PM logging",
    ...
    "coursePhaseMixBasis": "pooled non-PM hours of 12 full-coverage full_course projects (926.5h)",
    "calendarWeeks": {
      "consult_or_studio": {
        "n": 1,
        "values": [
