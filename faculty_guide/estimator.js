...
(function (root) {
  ...
  var CALIBRATION =
  {
    "provenance": "data_all/time_entries.csv (2,365 entries, 2129.8h, 2024-08-19..2026-06-16, ODL staff time) | 25 full-coverage course-dev projects >=10h (derived/ground_truth.csv); production rates from the 21 of them with >=10h non-PM logging",
    ...
    "coursePhaseMixPct": {
      "Production": 31.8,
      "Post-Production": 24.6,
      "Development/Build": 17.0,
      "Pre-Production": 16.8,
      "Design": 8.2,
      "Other / unsorted": 1.0,
      "Discovery": 0.4
    },
    "coursePhaseMixBasis": "pooled non-PM hours of 14 full-coverage full_course projects (913.5h)",
    "calendarWeeks": {
      "consult_or_studio": {
        "n": 1,
        "values": [
    ...
    "impactTracker": {
      ...
      "up_to_date_pct_of_tracked": 68.8,
      "outdated_projects": [
        {
      ...
      "hours_crosscheck": {
        ...
        "rows": [
          ...
          },
          {
            ...
            "asana_logged_hours": 90.5,
            "ratio_logged_over_reported": 0.75
          }
        ],
