...
(function (root) {
  ...
  var CALIBRATION =
  {
    "provenance": "data_all/time_entries.csv (3,345 entries, 2907.0h, 2024-07-10..2026-08-13, ODL staff time) | 23 full-coverage course-dev projects >=10h (derived/ground_truth.csv); production rates from the 19 of them with >=10h non-PM logging",
    ...
    "coursePhaseMixPct": {
      ...
      "Development/Build": 19.9,
      "Pre-Production": 11.5,
      "Design": 8.2,
      "Other / unsorted": 1.4,
      "Discovery": 0.3
    },
    "coursePhaseMixBasis": "pooled non-PM hours of 12 full-coverage full_course projects (914.3h)",
    "calendarWeeks": {
      "consult_or_studio": {
        "n": 1,
        "values": [
    ...
    "impactTracker": {
      ...
      "basis": "data_all/projects.csv Asana project custom field across 234 pulled projects",
      "total_projects": 234,
      "tracked_projects": 33,
      "blank_projects": 201,
      "coverage_pct": 14.1,
      ...
      "up_to_date_pct_of_tracked": 42.4,
      "outdated_projects": [
        {
        ...
        {
          "project_gid": "1211360177216094",
          "project": "360 XR Workshop",
          "status": "Outdated"
        },
        {
        ...
        {
          "project_gid": "1212627165986472",
          "project": "Borgo Laudato Si' videos",
          "status": "Outdated"
        },
        {
